...
public class Encoder {
        ...
        //takes in data for one channel and turns it into two channels
        private  double[] interleaveSamples(double[] mono) {
                double[] interleavedSamples = new double[mono.length*2];
        ...
        private  void appendOutput(double[] in, int startIndex, double[] out) {
        ...
        public  String realencode(String message, String filePath) {
                
                String outPath = filePath.substring(0,filePath.length()-4)+"-Encoded.wav";
                System.out.println("hello 1");
                audioFile = new File(filePath);
                System.out.println("hello 2");
                encodeMessage(message,outPath);
